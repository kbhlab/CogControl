...
plot_full_trials_7 <- time_series_summary %>%
  filter(age_group == "7 months") %>%
  ggplot(aes(x = Time, y = prop_looking, color = aoi, linetype = language)) + 
  geom_line() +
...
plot_full_trials_20 <- time_series_summary %>%
  filter(age_group == "20 months") %>%
  ggplot(aes(x = Time, y = prop_looking, color = aoi, linetype = language)) + 
  geom_line() +
  facet_grid(trial_labels ~ trial_type) +
...
ggsave("full_trials_7.png", plot = plot_full_trials_7, device = "png", width = 15, height = 10, units = "in",
  dpi = 300)

ggsave("full_trials_20.png", plot = plot_full_trials_20, device = "png", width = 15, height = 10, units = "in",
  dpi = 300)
