...
This script was by Hilay Kilam and Rodrigo Dal Ben.
...
```{r}
study <- "3" # options: "1a", "1b", "1c", "1d", "2"
filtered_or_not <- "filtered" # options: "filtered" OR "unfiltered"

# ONLY for the filtered sample of study 2, otherwise, leave FALSE
...
```{r}
dataset <- paste(study, filtered_or_not, sep = "_")

if (dataset == "1b_filtered"){
    ...
    MIN_NUMBER_TRIALS <- 0
    TL_PROP <- 1 # nobody is excluded
    
    print(paste("Data from Study", study, "with the", filtered_or_not, "sample will be analyzed.", sep = " "))
    
  } else if (dataset == "1c_filtered"){
  
    analysis_dataset <- 
    
    ANTICIP_START_OFF <-  + 150 # anticipation start + offset 
    ANTICIP_END_OFF <-  + 150 # anticipation start + offset 

    MIN_LOOK_PROPORTION <- .5
    MIN_NUMBER_TRIALS <- 7 
    TL_PROP <- .5 # nobody is excluded
    
    print(paste("Data from Study", study, "with the", filtered_or_not, "sample will be analyzed.", sep = " "))

  } else if (dataset == "1c_unfiltered"){
  ...
  } else if (dataset == "2_filtered" && vocabulary == TRUE){
    
    ## add variables here
    
    print(paste("Data from Study", study, "with the", filtered_or_not, "sample, and vocabulary as predictor will be analyzed.", sep = " "))
    
  } else if (dataset == "2_filtered" && vocabulary == FALSE){
    
    ## add variables here
    print(paste("Data from Study", study, "with the", filtered_or_not, "sample, without vocabulary as predictor, will be analyzed.", sep = " "))
    
  } else if (dataset == "2_unfiltered"){
