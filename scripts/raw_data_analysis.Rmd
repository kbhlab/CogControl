...
model_data_20_pre %>% 
  ...
  geom_jitter(aes(fill = cdi_tot_vocab_prod), alpha = 0.5, shape = 21, stroke = .75) + 
  geom_smooth(aes(color = as.factor(trial_num_scaled)), se = FALSE) + 
...
ggsave("plot_model_data_20pre.png", path = here("figures"), device = "png", width = 7, height = 7, units = "in",
   dpi = 300)
...
ggsave("plot_model_data_20post.png", path = here("figures"), device = "png", width = 7, height = 7, units = "in",
   dpi = 300)
