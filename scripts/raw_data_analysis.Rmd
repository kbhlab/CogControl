...
summary(tb_pre7_int)
summary(tb_post7_int)
summary(tb_pre20_int)
summary(tb_post20_int)

ggpredict(tb_pre7_int, c("trial_num_start_0", "language")) %>% plot()
...
ggpredict(tb_pre7_int, terms = c("TimeBin", "trial_num_start_0", "language"), type = "re") %>% plot()
ggpredict(tb_post7_int, terms = c("TimeBin", "trial_num_start_0", "language"), type = "re") %>% plot()
ggpredict(tb_pre20_int, terms = c("TimeBin", "trial_num_start_0", "language"), type = "re") %>% plot()
ggpredict(tb_post20_int, terms = c("TimeBin", "trial_num_start_0", "language"), type = "re") %>% plot()
...
blocks_figure_circle <- block_data %>%
  ...
  scale_fill_manual(values = c("#AAAAAA", # bilingual colour
                               "#565656")) + # mono colour
  xlab("Block number") +
