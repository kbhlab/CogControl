...
analysis_dataset <- 
  #data_full_trials #filtered sample (53 infants - article)
  dataset_exp1_v3 #full sample (102 infants - supplementary)
```
...
Based on D'Souza et al. (2020) description, the anticipation interval started at `3500ms` after trial onset (p. 6, Fig 1: `500 + (800*3) + (300*2) = 3500`), but there is no events for "fixation". 
...
data_eyetracking_clean_nocircle <- make_eyetrackingr_data(analysis_dataset, 
                                participant_column = "id",
                                trial_column = "trial_name", 
                                time_column = "time_align", 
                                trackloss_column = "trackloss", 
                                ...
                                treat_non_aoi_looks_as_missing = TRUE) %>%
  subset_by_window(window_start_time = ANTICIP_START_OFF,
                   window_end_time = ANTICIP_END_OFF, rezero = TRUE, remove = TRUE) %>%
...
ggsave("plot_time_series_full_trial_full_v2.png", 
...
tab_model(final_model_pre, show.re.var = FALSE, show.icc = FALSE)
          #file = here("03_Output/02_re_analysis/glermodel_pre_dsouza_pruned_full_full_v2.doc")) # uncomment to save
tab_model(final_model_post, show.re.var = FALSE, show.icc = FALSE) 
          #file = here("03_Output/02_re_analysis/glermodel_pos_dsouza_pruned_full_full_v2.doc"))
...
ggsave("plot_model_dsouza_pre_glmer_full_v2.png", 
       path = here("03_output/02_re_analysis/"), 
...
ggsave("plot_model_dsouza_post_glmer_full_v2.png", 
       path = here("03_output/02_re_analysis/"), 
       device = "png", width = 7, height = 4, units = "in", dpi = 300)
```
