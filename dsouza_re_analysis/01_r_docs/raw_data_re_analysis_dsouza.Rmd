...
```{r}
load(here("03_output/01_wrangling/data_full_trials.rda")) # filtered 51 sample - main article
load(here("03_output/01_wrangling/dataset_exp1_v3.rda")) # full 102 sample - comparison on supplements
```
...
data_eyetracking_full_trials <- make_eyetrackingr_data(data_full_trials, #dataset_exp1_v3, 
                                ...
                                trackloss_column = "trackloss", #"look_away",
...
line_colors <- c("#D55E00", "#0072B2") #c("#f77a6f", "#016abf") # cb_palette here
...
time_series_full_trial <-
  ...
  filter(Time >= 2400 & Time <= 5000) %>% # adjusted (cogcontrol = 1400-4000, w/ interest area = 2150, 3150 ; D'Souza = 2400-6600, w/ interest area = 3200, 4200)
  ...
  scale_x_continuous(breaks = c(3000, 4000, 5000)) + # adjusted here
  ...
  ggtitle("Time course of infant looking for Study 1b") + # age_group
...
ggsave("plot_time_series_full_trial_filter_v2.png", path = here("03_output/02_re_analysis/"), 
       width = 9, height = 9, units = "in", dpi = 300) # 2700 x 2700 pixels (same as study 1a)
...
ggsave("plot_model_dsouza_pre_glmer_filtered_v2.png", path = here("03_output/02_re_analysis/"), device = "png", width = 7, height = 4, units = "in", dpi = 300)
...
ggsave("plot_model_dsouza_post_glmer_filtered_v2.png", path = here("03_output/02_re_analysis/"), device = "png", width = 7, height = 4, units = "in", dpi = 300)
...
apa.ezANOVA.table(pre,
                  ...
                  filename = here("03_output/02_re_analysis/anova_table_pre_full.doc"))
...
block_data %>%
  ...
  apa.2way.table(iv1 = block_num, 
                 ...
                 filename = here("03_output/02_re_analysis/means_table_pre_full.doc"), 
                 table.number = 4)
...
apa.ezANOVA.table(post,
                  ...
                  filename = here("03_output/02_re_analysis/anova_table_post_full.doc"))
...
block_data %>%
  ...
  apa.2way.table(iv1 = block_num, 
                 ...
                 data = ., 
                 show.marginal.means = FALSE,
                 filename = here("03_output/02_re_analysis/means_table_post_full.doc"), 
                 table.number = 4)
