...
load(here("03_output/01_wrangling/data_full_trials.rda")) # full data
```
...
ggsave("plot_model_dsouza_pre_glmer.png", path = here("03_output/02_re_analysis/"), device = "png", width = 7, height = 4, units = "in", dpi = 300)
...
ggsave("plot_model_dsouza_post_glmer.png", path = here("03_output/02_re_analysis/"), device = "png", width = 7, height = 4, units = "in", dpi = 300)
