...
time_series_full_trial <-
  ...
  ggtitle("Time course of infant looking in \n D'Souza et al. (2020) - Experiment 1") + # age_group
...
tab_model(final_model_pre, show.re.var = FALSE, show.icc = FALSE, file = here("03_Output/02_re_analysis/glermodel_pre_dsouza_pruned_full.doc"))
tab_model(final_model_post, show.re.var = FALSE, show.icc = FALSE, file = here("03_Output/02_re_analysis/glermodel_pos_dsouza_pruned_full.doc"))
